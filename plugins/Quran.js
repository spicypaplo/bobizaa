...
let handler = async (m, { args, usedPrefix, command }) => {
    if (!(args[0] || args[1])) throw `*هــكذا : ${usedPrefix + command} 18 3*\n*الــرقم الـأول رقـم الـسورة, و الـرقـم الــثانـي رقـم الـايه*`
    if (isNaN(args[0]) || isNaN(args[1])) throw `*هــكذا : ${usedPrefix + command} 18 3*\n*الــرقم الـأول رقـم الـسورة, و الـرقـم الــثانـي رقـم الـايه*`
